...
var _user$project$Main$defaultButtons = function () {
	...
	return A2(
		_elm_lang$core$List$map,
		function (alphabetChar) {
			return {letter: alphabetChar, guess: false};
		},
		alphabet);
}();
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {apiResponse: a, buttons: b, guessLetters: c, numOfLives: d, currentWord: e};
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Hangman Game'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
